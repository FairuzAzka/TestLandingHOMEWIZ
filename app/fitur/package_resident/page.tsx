...
export default function ResidentPackagePage() {
  return (
      ...
      <section className="py-16">
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <p className="text-gray-600 mb-12 text-center">
            Fitur List Data Package di Homewizz memungkinkan penghuni, staff, dan pengelola untuk melihat daftar paket
        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <p className="text-gray-600 mb-6">
                Fitur Detail Package dengan Work Track di Homewizz memungkinkan penghuni untuk melihat informasi detail
                paket yang diterima dan telah diambil secara real time melalui aplikasi handphone. Jika terjadi masalah
                dengan paket, Homewizz memungkinkan penghuni untuk melaporkan keluhan dengan detail dan transparan.
              </p>
