...
export default function KaryawanReportPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16">
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="mb-24">
            <h2 className="text-2xl font-bold text-center mb-2">Report Online Cukup dengan smartphone</h2>
            <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
              Laporkan berbagai permasalahan apartemen langsung dari smartphone Anda. Pengajuan laporan lebih fleksibel
              dengan berbagai fitur yang kami sediakan.
            </p>
            <div className="flex justify-center">
              <Image
                src="/images/BenerinAC.png?height=600&width=300"
                alt="Mobile Report Interface"
                width={500}
                height={700}
              />
            </div>
          ...
          <div className="mb-24">
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="md:w-1/2">
                <Image
                  src="/images/ListaDataReport.png?height=600&width=300"
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 mb-6">
                  Dengan fitur ini, pengguna dapat langsung membuat, mengelola, dan memantau laporan permasalahan apartemen melalui aplikasi. Semua laporan tersimpan dengan rapi dan dapat diakses kapan saja.
                </p>
          ...
          <div className="mb-24">
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="md:w-1/2">
                <h2 className="text-2xl font-bold mb-4">Review Report Form dari Resident</h2>
                <p className="text-gray-600 mb-6">
                Form review yang mudah digunakan memungkinkan resident untuk memberikan feedback dengan cepat. Dengan sistem pelaporan online, setiap laporan menjadi terstruktur dan mudah ditindaklanjuti.
                </p>
                <div className="flex gap-3">
                  <Link href="#" className="px-6 py-2 bg-emerald-500 text-white rounded-md hover:bg-emerald-600">
                    Download Gratis
